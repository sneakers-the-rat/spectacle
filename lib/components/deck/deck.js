...
var DeckContext = /*#__PURE__*/(0, _react.createContext)();
...
var Portal = (0, _styledComponents.default)('div')(function (_ref) {
...
var Deck = /*#__PURE__*/(0, _react.forwardRef)(function (_ref2, ref) {
  ...
  _ref2$theme$size = _ref2$theme$size === void 0 ? {
    width: _defaultTheme.default.size.width,
    height: _defaultTheme.default.size.height
  } : _ref2$theme$size;
  ...
  }), /*#__PURE__*/_react.default.createElement(DeckContext.Provider, {
    value: {
      deckId: deckId,
...
Deck.propTypes = {
  ...
  overviewScale: _propTypes.default.number,
  printScale: _propTypes.default.number,
  ...
  onMobileSlide: _propTypes.default.func,
  disableInteractivity: _propTypes.default.bool,
  notePortalNode: _propTypes.default.node,
  ...
  suppressBackdropFallback: _propTypes.default.bool,
